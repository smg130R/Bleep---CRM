  ...
  if (tab === 'planner') return (
    <div className="view-section active">
      <Section title="HR Planner" action={isHR && <button className="btn btn-primary" style={{padding:'4px 12px',fontSize:12}} onClick={()=>setShowForm('planner')}><Plus size={12}/> Event</button>}>
        <div className="table-responsive" style={{maxHeight:520,overflow:'auto'}}><table className="data-table"><thead><tr><th style={{width:100}}>Date</th><th style={{width:70}}>Time</th><th>Title</th><th>Type</th><th style={{width:90}}>Status</th><th>Participants</th></tr></thead>
  ...
  if (tab === 'exit') return (
    <div className="view-section active">
      <Section title="Exit Management" action={isHR && <button className="btn btn-primary" style={{padding:'4px 12px',fontSize:12}} onClick={()=>setShowForm('exit')}><Plus size={12}/> Record</button>}>
        ...
        <div className="table-responsive"><table className="data-table"><thead><tr><th>Employee</th><th>Resigned</th><th>Last Day</th><th>Clearance</th><th>Settlement</th><th>Exp Letter</th><th style={{width:90}}>Status</th></tr></thead>
